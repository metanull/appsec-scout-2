...
.DESCRIPTION
    ...
    lightweight request to the Azure DevOps REST API (listing one project). Use this
    to isolate a credential/organization/network problem before running a full
...
.PARAMETER Credential
    ...
    across the organization. UserName is not used (Azure DevOps PATs authenticate via
