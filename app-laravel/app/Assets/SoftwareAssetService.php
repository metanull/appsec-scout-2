...
final class SoftwareAssetService
{
    ...
    public function attach(SoftwareAsset $asset, SoftwareSystem $system, User $author): SoftwareSystem
    {
    ...
    public function detach(SoftwareSystem $system, User $author): SoftwareSystem
    {
