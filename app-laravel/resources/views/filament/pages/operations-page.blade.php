                ...
                @forelse ($this->recentFailedJobs() as $failedJob)
                    <div class="rounded-xl border border-gray-200 bg-white p-4">
                        <div class="flex flex-wrap items-center justify-between gap-3">
                            <div>
                                <div class="font-medium text-gray-950">{{ $failedJob['job'] }}</div>
                        ...
                        <pre class="mt-3 max-h-48 overflow-auto whitespace-pre-wrap rounded-lg bg-gray-950 px-3 py-2 text-xs text-gray-100">{{ $failedJob['exception_preview'] }}</pre>
                        <pre class="mt-3 max-h-36 overflow-auto whitespace-pre-wrap rounded-lg bg-gray-100 px-3 py-2 text-xs text-gray-800">{{ $failedJob['payload_preview'] }}</pre>
                    </div>
                @empty
